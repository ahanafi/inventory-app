    ...
    <section class="content">
        <div class="box">
			<div class="box-header with-border">
				<div class="col-md-3">
				<?php echo form_open(site_url('laporan/penerimaan'), 'class="form-horizontal"'); ?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr class="bg-green">
                            ...
                            <th width="12.5%">Tanggal Beli</th>
                            <th width="15%">Tanggal Terim</th>
                    ...
                    <tbody>
						...
						<tr>
							...
							<td><?php echo getTanggal($row['tanggal_beli']);?></td>
            ...
            <div class="box-footer">
            	<a
					href="<?php echo site_url('laporan/cetak_penerimaan/');?>"
					type="button"
