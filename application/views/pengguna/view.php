    ...
    <section class="content">
        <div class="box">
			<div class="box-header with-border">
				<a
					href="<?php echo site_url('pengguna/add/');?>"
					type="button"
                ...
                <table id="example1" class="table table-bordered table-striped">
					...
					<?php foreach($pengguna as $row):?>
						<tr>
							...
							<td align="center">
								<a
									href="<?php echo site_url('pengguna/detail/' . $row['id']);?>"
									type="button"
								...
								<a
									href="<?php echo site_url('pengguna/edit/' . $row['id']);?>"
									type="button"
									class="btn btn-flat btn-sm btn-success"
									data-toggle="tooltip"
									data-placement="top"
								...
								<span
									...
									data-href="<?php echo site_url('pengguna/delete/' . $row['id']);?>"
								>
									<a
										type="button"
